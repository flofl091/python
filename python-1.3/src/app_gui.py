...
class ToDoListGUI(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        self.search_entry = ctk.CTkEntry(self, textvariable=self.search_var, width=300, placeholder_text="Rechercher...")
        ...
        # Save Tasks Button
        self.save_tasks_button = ctk.CTkButton(self, text="Sauvegarder les tâches", command=self.save_tasks)
        self.save_tasks_button.pack(pady=10)

        # Load Tasks Button
        self.load_tasks_button = ctk.CTkButton(self, text="Charger les tâches", command=self.load_tasks)
